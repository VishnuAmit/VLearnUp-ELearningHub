  ...
  return (
    ...
    >
      <div className="w-[1470px] flex flex-row flex-wrap items-start justify-center gap-[60px] max-w-full mq850:gap-[30px]">
        <div className="flex-1 shadow-[0px_10px_60px_rgba(38,_45,_118,_0.08)] rounded-xl bg-white flex flex-col items-end justify-start pt-[122px] pb-[50px] pr-[37px] pl-9 box-border gap-[24px] min-w-[337px] max-w-full mq450:pt-[79px] mq450:pb-8 mq450:box-border mq450:min-w-full transition-shadow duration-300 hover:shadow-[0px_20px_80px_rgba(38,_45,_118,_0.2)] hover:scale-[1.02]">
          ...
          <b className="self-stretch relative text-xl leading-[180%] text-slategray-100 z-[1] mq450:text-base mq450:leading-[29px]">
            AI creates personalized learning paths to fit each student’s unique needs, enhancing engagement and overall success.
          </b>
        </div>
        <div className="flex-1 shadow-[0px_10px_60px_rgba(38,_45,_118,_0.08)] rounded-xl bg-white flex flex-col items-end justify-start pt-[122px] pb-[50px] pr-[37px] pl-9 box-border relative gap-[24px] min-w-[337px] max-w-full mq450:pt-[79px] mq450:pb-8 mq450:box-border mq450:min-w-full transition-shadow duration-300 hover:shadow-[0px_20px_80px_rgba(38,_45,_118,_0.2)] hover:scale-[1.02]">
          ...
          <b className="self-stretch relative text-xl leading-[180%] text-slategray-100 z-[1] mq450:text-base mq450:leading-[29px]">
            Participate in live video sessions, join discussion forums, and collaborate on projects from anywhere in the world.
          </b>
        ...
        <div className="flex-1 shadow-[0px_10px_60px_rgba(38,_45,_118,_0.08)] rounded-xl bg-white flex flex-col items-end justify-start pt-[122px] pb-[50px] pr-[37px] pl-9 box-border gap-[24px] min-w-[337px] max-w-full mq450:pt-[79px] mq450:pb-8 mq450:box-border mq450:min-w-full transition-shadow duration-300 hover:shadow-[0px_20px_80px_rgba(38,_45,_118,_0.2)] hover:scale-[1.02]">
          ...
          <b className="self-stretch relative text-xl leading-[180%] text-slategray-100 z-[1] mq450:text-base mq450:leading-[29px]">
            Instant feedback on assignments with AI-powered automated grading ensures consistency, accuracy, and saves valuable time.
          </b>
        </div>
      </div>
    </section>

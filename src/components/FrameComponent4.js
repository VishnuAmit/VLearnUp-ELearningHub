        ...
        <div className="flex-1 flex flex-col items-start justify-start pt-[74px] px-0 pb-0 box-border min-w-[636px] max-w-full text-5xl text-darkslategray font-nunito-sans mq850:pt-12 mq850:box-border mq850:min-w-full">
          <div className="self-stretch flex flex-col items-start justify-start gap-[95px] max-w-full mq850:gap-[24px] mq1225:gap-[47px]">
            <div className="w-[324px] flex flex-row items-start justify-start py-0 px-3 box-border max-w-full">
              <div className="flex-1 [backdrop-filter:blur(20px)] rounded-xl bg-gray-300 flex flex-row items-start justify-start py-[15px] px-[26px] gap-[28px] z-[4] mq450:flex-wrap">
                <div className="h-[100px] w-[300px] relative [backdrop-filter:blur(20px)] rounded-xl bg-gray-300 hidden" />
                ...
                <div className="flex flex-col items-start justify-start">
                  <div className="h-[34px] flex flex-row items-start justify-start pt-0 px-0 pb-0 box-border">
                    <b className="mb-[-9px] relative tracking-[0.02em] leading-[180%] inline-block min-w-[26px] shrink-0 z-[1] mq450:text-lgi mq450:leading-[35px]">
                      AI
                    </b>
                  </div>
            ...
            <div className="self-stretch flex flex-col items-start justify-start gap-[30px] max-w-full">
              <div className="self-stretch flex flex-row items-start justify-end max-w-full">
                <div className="flex flex-row items-start justify-start py-5 pr-4 pl-[26px] box-border relative gap-[24px] max-w-full z-[4] mq850:flex-wrap">
                  <div className="h-full w-full absolute !m-[0] top-[0px] right-[0px] bottom-[0px] left-[0px] [backdrop-filter:blur(20px)] rounded-xl bg-gray-300" />
                  <div className="w-[50px] flex flex-col items-start justify-start pt-2.5 px-0 pb-0 box-border">
                    <div className="self-stretch h-[50px] relative rounded-lg bg-chocolate z-[1]">
                      <div className="absolute top-[0px] left-[0px] rounded-lg bg-chocolate w-full h-full hidden" />
                      <img
                    ...
                    <div className="w-[254px] h-[34px] flex flex-row items-start justify-between shrink-0 gap-[20px]">
                      ...
                      <div className="flex flex-col items-start justify-start pt-px px-0 pb-0">
                        <div className="w-5 h-5 relative">
                          <div className="absolute top-[0px] left-[0px] rounded-[50%] bg-silver w-full h-full z-[1]" />
                          <img
              ...
              <div className="w-[390px] [backdrop-filter:blur(20px)] rounded-xl bg-gray-300 flex flex-row items-start justify-start pt-5 px-[26px] pb-7 box-border gap-[22px] max-w-full z-[4] mq450:flex-wrap">
                <div className="h-[187px] w-[390px] relative [backdrop-filter:blur(20px)] rounded-xl bg-gray-300 hidden max-w-full" />
                <div className="w-[57px] flex flex-col items-start justify-start pt-1.5 px-0 pb-0 box-border">
                  <div className="self-stretch h-[59px] relative">
                    <img
                      className="absolute top-[0px] left-[0px] w-14 h-14 object-cover z-[1]"
                      loading="lazy"
                      alt=""
                      src="/ellipse@2x.png"
                    />
                    <div className="absolute top-[39px] left-[37px] rounded-[50%] bg-mediumseagreen box-border w-5 h-5 z-[2] border-[0px] border-solid border-antiquewhite" />
                  </div>
                </div>

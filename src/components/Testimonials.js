...
const Testimonials = ({ className = "" }) => {
  return (
    <section
      className={`self-stretch flex flex-row items-start justify-center pt-0 px-5 box-border max-w-full text-left text-xl text-darkslateblue-200 font-nunito-sans mq850:pb-[62px] mq850:box-border mq1225:pb-[95px] mq1225:box-border ${className}`}
    >
      <div className="h-[785px] w-[1728px] relative max-w-full mq1500:h-auto mq1500:min-h-[785]">
        <div className="relative left-[0px] w-full flex flex-row items-start justify-between max-w-full gap-[20px] text-7xl text-slategray-100 font-poppins mq1500:flex-wrap mq1500:gap-[50px]">
            ...
            <div className="self-stretch flex flex-col items-start justify-start gap-[37px] max-w-full mq850:gap-[18px]">
              <div className="self-stretch flex flex-row items-start justify-start py-0 pr-0 pl-0.5 box-border max-w-full">
                <div className="flex-1 flex flex-col items-start justify-start gap-[25px] max-w-full">
                  <div className="relative top-[-10px] left-[0px] flex flex-row items-start justify-start gap-[30px]">
                    ...
                    <b className="relative font-nunito-sans tracking-[0.2em] mq450:text-base">
                      TESTIMONIAL
                    </b>
                  </div>
                  <div className="font-nunito-sans relative left-[0px] w-[612px] flex flex-col items-start justify-start gap-[22px] max-w-full text-41xl text-darkslateblue-300">
          ...
          <div className="w-[800px] relative top-[-50px] flex flex-col items-start justify-start gap-[88px] min-w-[800px] max-w-full text-3xl text-slategray-300 font-nunito-sans mq450:gap-[22px] mq850:gap-[44px] mq850:min-w-full m-auto">
            <div className="self-stretch flex flex-row items-start justify-start relative max-w-full">
              <img
                className="h-[779px] w-[560px] relative !m-[0] rounded-xl object-cover"
                loading="lazy"
                alt=""
                src="/image-15@2x.png"
              />
              <div className="w-[640px] h-20 flex flex-row items-start justify-center py-0 px-5 box-border max-w-full">
                <div className="h-20 w-20 absolute top-[280px] right-[150px] z-[1] flex items-center justify-center">
                  <img
              ...
              <div className="flex-1 absolute top-[400px] left-[100px] shadow-[2px_4px_60px_rgba(41,_44,_124,_0.1)] rounded-mid bg-white flex flex-row items-start justify-center py-0 pr-6 pl-0 box-border gap-[31px] max-w-full z-[1] mq850:gap-[15px] mq850:p-5 mq850:box-border">
                ...
                <div className="flex-1 flex flex-col items-start justify-start pt-[41px] px-0 pb-0 box-border min-w-[383px] max-w-full mq850:min-w-full">
                  <div className="self-stretch flex flex-col items-start justify-start gap-[41px] max-w-full mq450:gap-[18px] mq850:gap-[35px]">
                    ...
                    <div className="self-stretch h-[68px] relative text-5xl">
                      <div className="relative top-[0px] left-[414px] flex flex-row items-start justify-start gap-[4.3px]">
                        <img
                      ...
                      <div className="relative top-[12px] left-[0px] leading-[180%] font-semibold z-[2] mq450:text-lgi mq450:leading-[35px]">
                        Amber Shaw
                      </div>
                      <div className="relative top-[16px] left-[394px] text-lg tracking-[0.02em] leading-[180%] font-semibold text-lightslategray z-[2]">
